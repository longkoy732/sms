                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-xs-10 col-sm-12 col-md-4">
                                    ...
                                    <input type='text' name="sndbirth" id="sndbirth" autocomplete="off" class="form-control" required>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                            ...
                                            <input type="text" name="snasprc" id="snasprc" autocomplete="off" class="form-control" />
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                            <label>Date Recv. Good Moral<span class="text-danger">*</span></label>
                                            <input type="text" name="snapgm" id="snapgm" autocomplete="off" class="form-control" />
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                            <label>Date Recv. 2x2 ID Picture<span class="text-danger">*</span></label>
                                            <input type="text" name="sntbytpic" id="sntbytpic" autocomplete="off" class="form-control" />
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-4">
                                            ...
                                            <input type="text" name="snpbrgyin" id="snpbrgyin" autocomplete="off" class="form-control" />
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-4 offset-md-4">
                                            <label>Date Recv. Enrollment Form<span class="text-danger">*</span></label>
                                            <input type="text" name="snpscef" id="snpscef" autocomplete="off" class="form-control" />
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-4">
